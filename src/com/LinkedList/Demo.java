...
//        printList(placesToVisit);
        ...
        addInOrder(placesToVisit,"Adelide");
    ...
    public static boolean addInOrder(LinkedList<String> linkedList, String newCity){
        ...
        while(stringListIterator.hasNext()){
            ...
            if(comparison == 0){
                // If it is equal than do not add
                System.out.println(newCity+" Is already included as your destination");
                return false;
                ...
                // do nothing & move to the next city
            }
            ...
            switch (action){
                ...
                case 2:
                    ...
                    if(listIterator.hasPrevious()){
                        ...
                        System.out.println("Reached to the top of the list");
                        goingForward=true;
                    }
                    break;
                case 3:
    ...
    private static void printMenu(){
        ...
        System.out.println("3 - to print the menu options");
    }
